...
document.addEventListener("DOMContentLoaded", function () {
        ...
        gsap.set(".page-wrapper", { opacity: 1 });
        const h1 = new SplitText(".heading-style-h4", {
          type: "words",
          mask: "words",
          wordsClass: "h1",
        });
        const p1 = new SplitText("[hero-p]", {
          type: "lines",
          mask: "lines",
        });
        ...
        const tl = gsap
          ...
          .from(
            ".section_blog7 .text-style-tagline",
            {
              y: 32,
              opacity: 0,
              filter: "blur(5px)",
        ...
        document.querySelectorAll(".blog7_pagination").forEach((btn) => {
        ...
        gsap.utils.toArray(".blog7_radio").forEach((el) => {
